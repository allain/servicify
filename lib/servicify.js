...
module.exports = function Servicify(opts) {
  opts = defaults(opts, {host: '127.0.0.1', port: 2020});

  // TODO: Make this configurable
  opts.driver = require('./drivers/pigato')(opts);
  ...
  function listen() {
    ...
    return opts.driver.listen(opts).then(function (stopper) {
      return Object.assign({}, opts, stopper);
    });
  }
  ...
  function offer(target, spec) {
    return new Promise(function (resolve) {
      ...
      return opts.driver.offer(spec, invoke, opts).then(function (offering) {
        return Object.assign({}, spec, opts, offering);
      }).then(resolve);
    });
  }
};
